...
def main():
    ...
    # Primary app: PyQt5 GUI Companion (includes enhanced emotion detection)
    primary_app = "apps/companions/pyqt5_companion_gui.py"
    ...
    if os.path.exists(primary_app):
        print("Starting PyQt5 GUI Companion (Best Experience)")
        print("Includes: Interactive companion + Enhanced emotion detection + Action Units")
        ...
        try:
            ...
            print(f"Error running PyQt5 companion: {e}")
            print("Trying fallback options...")
    else:
        print("PyQt5 GUI Companion not found, trying alternatives...")
